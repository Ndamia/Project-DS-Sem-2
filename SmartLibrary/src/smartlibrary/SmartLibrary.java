...
public class SmartLibrary implements LibraryADT {
    ...
    private void printMenu(){
        ...
        System.out.println("7.History Of Borrowed Book");
    ...
    private void handleChoice(int choice, Scanner sc){
        switch(choice){
            case 1:
                ...
                int isbn = sc.nextInt();
                sc.nextLine();
                Book duplicateBook = catalogue.search(isbn);
                if(duplicateBook != null){
                    System.out.println("\nError: Cannot add book. ISBN " + isbn + " already exist (" + duplicateBook.getTitle());
                    break;
                }
